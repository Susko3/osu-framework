...
namespace osu.Framework.Platform.MacOS
{
    public class MacOSGameHost : DesktopGameHost
    {
        ...
        internal static IEnumerable<KeyBinding> KeyBindings => new[]
        {
            ...
            new KeyBinding(new KeyCombination(InputKey.Super, 'w'), PlatformAction.DocumentClose),
            new KeyBinding(new KeyCombination(InputKey.Super, 'n'), PlatformAction.DocumentNew),
            new KeyBinding(new KeyCombination(InputKey.Super, 't'), PlatformAction.TabNew),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.Shift, 't'), PlatformAction.TabRestore),
            ...
            new KeyBinding(new KeyCombination(InputKey.Super, 's'), PlatformAction.Save),
            ...
            new KeyBinding(new KeyCombination(InputKey.Super, 'z'), PlatformAction.Undo),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.Shift, 'z'), PlatformAction.Redo),
